...
public class BDHDGeter {
	...
	// }!@#$%\\^&\\+'\"
	final static String p1 = "bdhd[:][/][/][0-9]+[|][0-9a-zA-Z]+[|].+?[\\{\\}<>!@#$%\\^&\\+'\"\\s]";
	final static String p2= "ed2k[:][/][/][|]file[|].+?[|].+?[|].+?[\\{\\}<>!@#$%\\^&\\+'\"\\s]";
	
	public static ArrayList<String> searchBDHD(String input){
		ArrayList<String> arr = new ArrayList<String>();
		arr.addAll(searchBDHD(input, p1));
		arr.addAll(searchBDHD(input, p2));
		return arr;
	}
	public static ArrayList<String> searchBDHD(String input,String p) {
		ArrayList<String> arr = new ArrayList<String>();
