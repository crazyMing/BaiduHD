...
public class RC4 {
    ...
    public static String decry_RC4(byte[] res, String key) {
        if (res == null || key == null) {
            return null;
        }
        return asString(RC4Base(res, key));
    }
    ...
    private static byte[] RC4Base (byte[] res, String mKkey) {
        int x = 0;
        int y = 0;
        ...
        for (int i = 0; i < res.length; i++) {
            ...
            result[i] = (byte) (res[i] ^ key[xorIndex]);
        }
        return result;
    }
}