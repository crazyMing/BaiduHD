...
int p2pservice_task_create( task_param_t* param, task_handle_t* h );
...
int p2pservice_task_stat( task_handle_t h, task_stat_t* stat);

int p2pservice_get_redirect(task_handle_t h, TCHAR* szURL);

int p2pservice_parse_url(TCHAR* szURL, url_info_t* pInfo);
